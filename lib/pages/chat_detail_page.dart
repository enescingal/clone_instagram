...
import 'package:clone_instagram/util/chat_detail_json.dart';
import 'package:clone_instagram/util/chat_json.dart';
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(chats[0]['profile'] as String),
                          fit: BoxFit.cover)),
                ),
                SizedBox(width: 15),
                Text(
                  chats[0]['username'] as String,
            ...
            Container(
              ...
              child: ListView(
                ...
                return Padding(
                  ...
                  child: ChatBubbles(
                    isMe: chatDetails[index]['isMe'] as bool,
                    profile: chatDetails[index]['profile'] as String,
                    message: chatDetails[index]['message'] as String,
                    messageNo: chatDetails[index]['messageNo'] as int,
                  ),
                );
              })),
            ),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: Icon(Feather.camera, color: textWhite),
                          ),
                        ),
                        Container(
